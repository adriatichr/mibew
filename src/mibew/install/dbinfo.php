...
$dbtables = array(
	...
	"${mysqlprefix}chatthread" => array(
		...
		"locale" => "varchar(8)",
		"lastpinguser" => "datetime",
		"lastpingagent" => "datetime",
	...
	"${mysqlprefix}chatoperator" => array(
		...
		"vccommonname" => "varchar(64) NOT NULL",
		"vcemail" => "varchar(64)",
		"dtmlastvisited" => "datetime",
		"istatus" => "int DEFAULT 0", /* 0 - online, 1 - away */
		"idisabled" => "int DEFAULT 0", /* 0 - account enabled, 1 - account disabled */
...
$dbtables_can_update = array(
	...
	"${mysqlprefix}chatoperator" => array("vcavatar", "vcjabbername", "iperm", "istatus", "idisabled", "vcemail", "dtmrestore", "vcrestoretoken", "inotify"),
	"${mysqlprefix}chatban" => array(),
